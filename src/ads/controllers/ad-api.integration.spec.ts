...
describe('Ad API integration', () => {
  ...
  beforeEach(async () => {
    adDecisionService.decide.mockResolvedValue({
      decision_id: '101',
  ...
  it('returns the single MVP ad decision response from POST /ads/decision', async () => {
    ...
    expect(adDecisionService.decide).toHaveBeenCalledWith({
      project_id: 'demo_project',
      user_id: 'user_001',
      slot_id: 'main_banner',
      page_url: '/products/chicken_001',
